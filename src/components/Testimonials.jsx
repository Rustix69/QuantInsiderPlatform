...
const ReviewCard = ({
    ...
    return (
        <figure
            className={cn(
                "relative w-64 cursor-pointer  sm:h-30 overflow-hidden rounded-xl border p-4",
                // light styles
        ...
        >
            ...
            <blockquote className="mt-4 text-xs sm:text-sm">{body}</blockquote>
        </figure>
    );
};
...
export function Testimonials() {
    return (
        <div className="relative flex h-auto mt-5 sm:mt-10 w-full flex-col overflow-hidden rounded-lg">
