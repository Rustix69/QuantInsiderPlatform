...
const ShinyButton = React.forwardRef(({ children, className, ...props }, ref) => {
  return (
    (<motion.button
      ...
      <span
        className="relative block size-full text-xs sm:text-sm lg:text-base uppercase tracking-tighter sm:tracking-wide text-[rgb(0,0,0,100%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
