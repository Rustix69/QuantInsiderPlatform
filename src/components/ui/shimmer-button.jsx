...
const ShimmerButton = React.forwardRef((
  ...
  return (
    (<button
      ...
      className={cn(
        "group relative h-2 md:h-10 sm:h-7 z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-1 sm:px-6 py-4 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-black",
