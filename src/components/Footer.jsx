            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <Link to="/education" className="text-gray-300 hover:text-white mb-2">Education</Link>
                        <Link to="/enterprise" className="text-gray-300 hover:text-white mb-2">Enterprise</Link>
                        <Link to="/events" className="text-gray-300 hover:text-white mb-2">Events</Link>
                        <Link to="/talks" className="text-gray-300 hover:text-white mb-2">Talks</Link>
                        <Link to="/about" className="text-gray-300 hover:text-white mb-2">About</Link>
                    </div>
