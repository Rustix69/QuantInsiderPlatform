...
import { RequestForm } from '@/components/RequestDemo'
    ...
    <div>
      ...
      <div className='flex sm:flex-row flex-col justify-between gap-5 px-5 mt-5'>
        <div className="py-5 relative first:h-[25vh] flex flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
          ...
          <p className='text-bsase px-5 text-center font-semibold mt-3'>Streamline trading operations, reduce manual processes, and
      ...
      <div className='flex sm:flex-row flex-col justify-between gap-5 px-5 mt-5'>
        ...
        <div className="py-5 relative first:h-[25vh] flex flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
          ...
          ></div>
          <Meteors number={50} />
          <h1 className='text-xl font-extrabold font-serif'>Phoeinix Suit</h1>
      ...
      <div className='flex flex-col items-center justify-center item-centre px-3 mt-10 sm:mt-16' id="request-demo">
