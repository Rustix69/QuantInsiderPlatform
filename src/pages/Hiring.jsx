import ServicesTree from '@/components/ServiceTree'
...
const Hiring = () => {
  ...
  return (
    <div>
      ...
      <p className='text-center text-xs lg:text-2xl font-serif font-extralight mt-2 lg:mt-10 tracking-tighter px-5 lg:px-20'>In the fast-paced world of finance, having the right talent can be the difference between leading the
        ...
        candidates who are not just qualified, but game-changers.</p>
